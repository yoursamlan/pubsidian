...
def md2html(fname):
    ...
    with open(inp, 'r') as f:
        text = f.read()
        text = markdown(text, extensions=[WikiLinkExtension(base_url='./', end_url='.html')])
        ...
        for img in soup.findAll('img'):
            ...
            img['src'] = "./OUTPUT/pages/Image/" + urlInfo.path
        html = str(soup)
...
def Welcome():
    print("\nWelcome to convert2web v1.0.5-beta\n"+"="*40)
